    ...
    <footer className="bg-white text-gray-800 border-t border-gray-200 mt-auto">
      <div className="max-w-6xl mx-auto px-6 py-10 md:py-12">
        <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-start">
          <div>
            <h3 className="text-lg font-semibold text-teal-blue mb-3">Our Location</h3>
            ...
            <div className="rounded-lg overflow-hidden border border-gray-200 aspect-video max-h-[220px] md:max-h-[200px]">
              <iframe
                src={MAP_EMBED_SRC}
                width="100%"
                height="100%"
          ...
          <div>
            <h3 className="text-lg font-semibold text-teal-blue mb-3">Contact</h3>
            <a
            ...
            <h3 className="text-lg font-semibold text-teal-blue mb-3">Related Links</h3>
            <a
            ...
            <div className="flex flex-wrap gap-3">
              <a
                ...
                rel="noopener noreferrer"
                aria-label="Facebook"
                className="flex items-center justify-center w-10 h-10 rounded-full bg-teal-blue/10 text-teal-blue hover:bg-lime-green hover:text-white transition-colors"
              >
