...
export default function SponsorPage() {
  return (
    <div>
      ...
      <PageSection className="bg-brand-motif">
      ...
      <PageSection className="bg-teal-blue/5" delay={0.05}>
      ...
      <PageSection className="bg-brand-motif" delay={0.1}>
        <h2 className="text-2xl md:text-3xl font-bold text-teal-blue mb-8">
      ...
      <section className="py-16 md:py-24 px-6 bg-teal-blue-dark text-white">
        <div className="max-w-4xl mx-auto">
          <Reveal>
            ...
            <Link
              href="/contact"
              className="inline-flex items-center justify-center px-6 py-3 rounded-lg font-semibold bg-lime-green text-white hover:opacity-90 transition hover:-translate-y-0.5"
            >
